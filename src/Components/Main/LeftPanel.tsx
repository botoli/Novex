...
import {category} from "../../assets/LeftPanel/index.js"
        ...
        <div className={style.main}>
            <div className={style.header}>
                <div className={style.naming}>
                    ...
                    <div className={style.namingtxt}><p>Рабочее пространство</p></div>
                </div>
                <div className={style.searchcont}>
                    <svg width="14" height="14" viewBox="0 0 14 14" fill="none" xmlns="http://www.w3.org/2000/svg">
                        <path d="M6 0C9.3136 1.28863e-07 11.9998 2.68644 12 6C12 7.41644 11.5074 8.7168 10.6865 9.74316L13.1377 12.1953C13.398 12.4557 13.398 12.8773 13.1377 13.1377C12.8773 13.398 12.4557 13.398 12.1953 13.1377L9.74316 10.6865C8.7168 11.5074 7.41644 12 6 12C2.68644 11.9998 1.28867e-07 9.3136 0 6C0.000175991 2.68655 2.68655 0.000175988 6 0ZM6 1.33398C3.42293 1.33416 1.33416 3.42293 1.33398 6C1.33398 8.57722 3.42282 10.6668 6 10.667C8.57733 10.667 10.667 8.57733 10.667 6C10.6668 3.42282 8.57722 1.33398 6 1.33398Z" fill="white" fillOpacity="0.4"/>
                    </svg>
            ...
            <div className={style.category}>
                {category.map((element, index) => (
                    <div
                        key={element.name}
                        className={`${style.categoryItem} ${activeCategory === index ? style.active : ''}`}
            ...
            <div className={style.suggestions}>
                <div className={style.glassCard}>
                    ...
                    {/* Компактный чат с ИИ */}
                    <form onSubmit={handleChatSubmit} className={style.chatInputContainer}>
